...
# ----------------------------
from .Framework.Data.database import get_db, Base, engine

# Importar serviços e routers
from .Framework.Services.Site.Pages.Conteudo.blog_service import BlogService
from .Api.routers import blog_router  # Supondo que você tenha criado blog_router.py

# ----------------------------
# Criar instância do FastAPI
# ----------------------------
app = FastAPI(title="Backend Replicado")
...
# Incluir routers
# ----------------------------
app.include_router(blog_router.router, prefix="/blog", tags=["Blog"], dependencies=[Depends(get_blog_service)])
