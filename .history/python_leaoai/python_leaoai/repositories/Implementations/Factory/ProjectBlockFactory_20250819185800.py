...
class ProjectBlockFactory:
    ...
    def get_all(self, ) -> List_ProjectBlock: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetList'
    def get_list(self, ) -> List_ProjectBlock: # Basic return type mapping
        pass
    ...
    def get_blocks_by_project(self, project_id: int) -> List_ProjectBlock: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetBlocksByProjectPhase'
    def get_blocks_by_project_phase(self, project_phase_id: int) -> List_ProjectBlock: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetBlocksForConclude'
    def get_blocks_for_conclude(self, ) -> List_ProjectBlock: # Basic return type mapping
        pass
    ...
    def get_blocks_by_user(self, usuario_id: int) -> List_ProjectBlock: # Basic return type mapping
        pass
