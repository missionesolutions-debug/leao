...
class ClienteFactory:
    ...
    def get_all(self, ) -> List_Cliente: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetList'
    def get_list(self, ) -> List_Cliente: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetAllAtivo'
    def get_all_ativo(self, ) -> List_Cliente: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetAllExcluido'
    def get_all_excluido(self, ) -> List_Cliente: # Basic return type mapping
        pass
