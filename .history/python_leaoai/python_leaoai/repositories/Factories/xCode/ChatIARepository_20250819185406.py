...
class ChatIARepository:
    ...
    async def get_all_chats_async(self, ) -> IEnumerable_ChatIA: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetAllChatsByUserIdAsync'
    async def get_all_chats_by_user_id_async(self, user_id: int) -> IEnumerable_ChatIA: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetAllChatsByUserIdAndTypedAsync'
    async def get_all_chats_by_user_id_and_typed_async(self, user_id: int, typed: string) -> IEnumerable_ChatIA: # Basic return type mapping
        pass
