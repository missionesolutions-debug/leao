...
class MetadataRepository:
    ...
    def get_objs_by_guid(self, id: string) -> List_Metadata: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetObjsByRefGuid'
    def get_objs_by_ref_guid(self, referenc: string) -> List_Metadata: # Basic return type mapping
        pass
    ...
    def get_all(self, ) -> List_Metadata: # Basic return type mapping
        pass
