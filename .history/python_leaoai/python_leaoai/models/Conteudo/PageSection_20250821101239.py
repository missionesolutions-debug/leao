...
class PageSection(Base):
    ...
    # Relações
    page_section_items = relationship("PageSectionItem", back_populates="page_section", cascade="all, delete-orphan")
    # style_properties = relationship("StyleProperty", back_populates="page_section", cascade="all, delete-orphan")
    # metadatas = relationship("Metadata", back_populates="page_section", cascade="all, delete-orphan")
