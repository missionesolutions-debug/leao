...
class ArquivoFactory:
    ...
    def get_all(self, ) -> List_Arquivo: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetList'
    def get_list(self, ) -> List_Arquivo: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetAllAtivo'
    def get_all_ativo(self, ) -> List_Arquivo: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetAllExcluido'
    def get_all_excluido(self, ) -> List_Arquivo: # Basic return type mapping
        pass
    ...
    def get_arquivos_without_table_action_and_table_id(self, ) -> List_Arquivo: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetArquivosByTableActionAndTableId'
    def get_arquivos_by_table_action_and_table_id(self, table_action: string, table_id: int) -> List_Arquivo: # Basic return type mapping
        pass
