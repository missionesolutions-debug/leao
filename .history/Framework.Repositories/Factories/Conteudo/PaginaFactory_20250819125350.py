...
class PaginaFactory:
    ...
    def get_all(self, ) -> List<Pagina>: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetAllAtivo'
    def get_all_ativo(self, ) -> List<Pagina>: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetAllExcluido'
    def get_all_excluido(self, ) -> List<Pagina>: # Basic return type mapping
        pass
    ...
    def get_paginas_by_categoria_id(self, id: int) -> List<Pagina>: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetAllToBlob'
    def get_all_to_blob(self, ) -> List<Pagina>: # Basic return type mapping
        pass
    ...
    def get_all_to_c_d_n(self, ) -> List<Pagina>: # Basic return type mapping
        pass
