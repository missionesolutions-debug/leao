...
class MenuFactory:
    ...
    def get_all(self, ) -> List<Menu>: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetList'
    def get_list(self, ) -> List<Menu>: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetAllAtivoWithPages'
    def get_all_ativo_with_pages(self, ) -> List<Menu>: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetAllAtivo'
    def get_all_ativo(self, ) -> List<Menu>: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetAllExcluido'
    def get_all_excluido(self, ) -> List<Menu>: # Basic return type mapping
        pass
