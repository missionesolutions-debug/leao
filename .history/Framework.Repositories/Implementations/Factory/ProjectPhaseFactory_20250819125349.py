...
class ProjectPhaseFactory:
    ...
    def get_all(self, ) -> List<ProjectPhase>: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetList'
    def get_list(self, ) -> List<ProjectPhase>: # Basic return type mapping
        pass
    ...
    def get_phases_by_project(self, project_id: int) -> List<ProjectPhase>: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetPhasesByProjectItem'
    def get_phases_by_project_item(self, project_item_id: int) -> List<ProjectPhase>: # Basic return type mapping
        pass
