...
class ProjectFactory:
    ...
    def get_all(self, ) -> List<Project>: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetList'
    def get_list(self, ) -> List<Project>: # Basic return type mapping
        pass
    ...
    def get_all_full(self, ) -> List<Project>: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetAllFullMech'
    def get_all_full_mech(self, ) -> List<Project>: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetProjectsByClient'
    def get_projects_by_client(self, client_id: int) -> List<Project>: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetProjectsBySupplier'
    def get_projects_by_supplier(self, supplier_id: int) -> List<Project>: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetProjectsByUsuario'
    def get_projects_by_usuario(self, usuario_id: int) -> List<Project>: # Basic return type mapping
        pass
