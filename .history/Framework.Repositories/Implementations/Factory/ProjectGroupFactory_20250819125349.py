...
class ProjectGroupFactory:
    ...
    def get_all(self, ) -> List<ProjectGroup>: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetList'
    def get_list(self, ) -> List<ProjectGroup>: # Basic return type mapping
        pass
    ...
    def get_groups_by_project_phase(self, project_phase_id: int) -> List<ProjectGroup>: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetGroupsByProject'
    def get_groups_by_project(self, project_id: int) -> List<ProjectGroup>: # Basic return type mapping
        pass
