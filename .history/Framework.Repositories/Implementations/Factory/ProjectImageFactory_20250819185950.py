...
class ProjectImageFactory:
    ...
    def get_all(self, ) -> List_ProjectImage: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetList'
    def get_list(self, ) -> List_ProjectImage: # Basic return type mapping
        pass
    ...
    def get_images_by_project(self, project_id: int) -> List_ProjectImage: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetImagesByProjectBlock'
    def get_images_by_project_block(self, project_block_id: int) -> List_ProjectImage: # Basic return type mapping
        pass
