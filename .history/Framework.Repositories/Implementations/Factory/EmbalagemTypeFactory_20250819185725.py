...
class EmbalagemTypeFactory:
    ...
    def get_all(self, ) -> List_EmbalagemType: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetListActives'
    def get_list_actives(self, ) -> List_EmbalagemType: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetList'
    def get_list(self, ) -> List_EmbalagemType: # Basic return type mapping
        pass
