...
class ProjectMeasureItemFactory:
    ...
    def get_all(self, ) -> List<ProjectMeasureItem>: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetList'
    def get_list(self, ) -> List<ProjectMeasureItem>: # Basic return type mapping
        pass
    ...
    def get_measure_items_by_project_block(self, project_block_id: int) -> List<ProjectMeasureItem>: # Basic return type mapping
        pass
