...
from app.schemas.Auth.authenticate import LoginRequest, AuthenticateResponse
...
# Caminho do diretório raiz do projeto (baseado no local deste arquivo)
BASE_DIR = Path(__file__).resolve().parents[3]  # sobe 3 pastas até chegar no "app"
