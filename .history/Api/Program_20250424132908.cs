...
.AddJwtBearer(options =>
{
    ...
    options.TokenValidationParameters = new TokenValidationParameters
    {
        ...
        ValidateIssuer = false, // Em produção, pode querer validar o emissor
        ValidateAudience = false // Em produção, pode querer validar o público
    };
});
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    // Adicionar requisito de segurança globalmente para todas as rotas
...
// Adicione o serviço de Output Caching
...
app.UseAuthentication(); // Adicione a autenticação
