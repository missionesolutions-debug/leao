...
class ProjectBlockResponse(BaseModel):
    ...
    measure_items: List[ProjectMeasureItemResponse] = Field(alias='MeasureItems', Field(default_factory=list)) # Corresponds to public List<ProjectMeasureItemResponse> MeasureItems
    images: List[ProjectImageResponse] = Field(alias='Images', Field(default_factory=list)) # Corresponds to public List<ProjectImageResponse> Images
    images_gallery: List[ImagesGalleryResponse] = Field(alias='ImagesGallery', Field(default_factory=list)) # Corresponds to public List<ImagesGalleryResponse> ImagesGallery
