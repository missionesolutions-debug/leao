...
class ProjectResponse(BaseModel):
    ...
    items: List[ProjectItemResponse] = Field(default_factory=list, alias='Items') # Corresponds to public List<ProjectItemResponse> Items
    assigned_users: List[UserResponse] = Field(default_factory=list, alias='AssignedUsers') # Corresponds to public List<UserResponse> AssignedUsers
