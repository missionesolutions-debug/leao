...
class StylePropertyService:
    ...
    def __init__(self, repository<_style_property>: object # TODO: Specify correct type hint):
        self.repository<_style_property> = repository<_style_property> # TODO: Assign dependency
