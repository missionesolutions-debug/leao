...
class TipoCategoriaFactory:
    ...
    def get_all(self, ) -> List_TipoCategoria: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetAllAtivo'
    def get_all_ativo(self, ) -> List_TipoCategoria: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetAllExcluido'
    def get_all_excluido(self, ) -> List_TipoCategoria: # Basic return type mapping
        pass
