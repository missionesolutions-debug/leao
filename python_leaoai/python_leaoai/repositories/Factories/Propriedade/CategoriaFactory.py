...
class CategoriaFactory:
    ...
    def get_all_category(self, ) -> List_Categoria: # Basic return type mapping
        pass
    ...
    def get_all(self, ) -> List_Categoria: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetAllAtivo'
    def get_all_ativo(self, ) -> List_Categoria: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetAtivos'
    def get_ativos(self, ) -> List_Categoria: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetAllExcluido'
    def get_all_excluido(self, ) -> List_Categoria: # Basic return type mapping
        pass
    ...
    def get_all_to_blob(self, ) -> List_Categoria: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetAllToCDN'
    def get_all_to_c_d_n(self, ) -> List_Categoria: # Basic return type mapping
        pass
