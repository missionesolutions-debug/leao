...
class PageFactory:
    ...
    def get_all(self, ) -> List_Page: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetList'
    def get_list(self, ) -> List_Page: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetAllAtivo'
    def get_all_ativo(self, ) -> List_Page: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetAllExcluido'
    def get_all_excluido(self, ) -> List_Page: # Basic return type mapping
        pass
    ...
    async def get_pages_for_sitemap_async(self, ) -> IEnumerable_Page: # Basic return type mapping
        pass
