...
class ProjectItemFactory:
    ...
    def get_all(self, ) -> List<ProjectItem>: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetList'
    def get_list(self, ) -> List<ProjectItem>: # Basic return type mapping
        pass
    ...
    def get_project_items_by_project(self, project_id: int) -> List<ProjectItem>: # Basic return type mapping
        pass
