...
class UserFactory:
    ...
    def get_all(self, ) -> List<User>: # Basic return type mapping
        pass

    # TODO: Translate logic from C# method 'GetAllAtivo'
    def get_all_ativo(self, ) -> List<User>: # Basic return type mapping
        pass
    ...
    def get_all_excluido(self, ) -> List<User>: # Basic return type mapping
        pass
