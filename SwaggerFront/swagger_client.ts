export type Swagger = {
  ...
  "/api/v1/blog/list": {
    get: {
      params: {category:string,search:string,tags:string,page:integer},
      requestBody: null,
      result: null
    }
  },
  ...
  "/api/v1/pages/{entityKey}/listing": {
    get: {
      params: {entityKey:string,category:string,search:string,tags:string,page:integer,pageSize:integer},
      requestBody: null,
      result: null
    }
  },
